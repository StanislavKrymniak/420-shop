...
const CategoryItem = () => {
    ...
    return (
        <main className='category-item_container'>
            <div className="category-item_columns">
                <div className="category-item_column_1">
                    <h1 className='category-item_title'>{product.name}</h1>
                    <div className="category-item_image">
                        <img src={product.imageUrl} alt={product.name} />
                    </div>
                    <p className='category-item_text'>Price: ${product.price}</p>
                </div>
                <div className="category-item_cloumn_2">
                    {category.toLowerCase() !== 'hats' && (
                        <>
                            <label htmlFor="size" className="category-item_choose">
                                Size:
                            </label>
                    ...
                    <button className="category-item_button" onClick={addProductToCart}>
                        Add to Cart
                    </button>
                    {confirmationMessage && (
